...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        // web中间件，应用于 routes/web.php 路由文件
     ...
     * 中间件别名设置，允许你使用别名调用中间件，例如上面的api 中间件组调用
     * @var array
     */
    protected $routeMiddleware = [
        ...
        // laravel 自带的强制用户邮箱认证的中间件，为了更加贴近我们的逻辑，已经被重写
     ...
     *  可以看到 StartSession 永远是最开始执行，因为 StartSession后，
