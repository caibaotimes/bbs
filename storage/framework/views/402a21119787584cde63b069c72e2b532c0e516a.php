          ...
          <div class="card">
              <div class="card-header bg-transparent">
                  <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a href="<?php echo e(Request::url()); ?>?order=default" class="nav-link <?php echo e(active_class(!if_query('order','recent'))); ?>">最后回复</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo e(Request::url()); ?>?order=recent" class="nav-link <?php echo e(active_class(if_query('order','recent'))); ?>">最新发布</a>
                    </li>
                  </ul>
              </div>
