...
<body>
	<div id="wrapper">
		<?php echo $__env->make('administrator::partials.header', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

		<?php echo $content; ?>


		<?php echo $__env->make('administrator::partials.footer', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	</div>
