    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 topic-content">
            <div class="card ">
                <div class="card-body">
                    ...
                    <div class="operate">
                        ...
                        <form action="<?php echo e(route('topics.destroy',$topic->id)); ?>" method="post" style="display: inline-block;" onsubmit="return confirm('确定要删除吗？')">
            ...
            <div class="card topic-reply mt-4">
                <div class="card-body">
                    <?php echo $__env->renderWhen(Auth::check(),'topics._reply_box',['topic'=>$topic], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path'))); ?>
